...
server {
    ...
    server_name  	admin.$DOMAIN_NAME/admin/public;
...
sudo apt install php8.2-mbstring php8.2-xml php8.2-bcmath php8.2-simplexml php8.2-intl php8.2-gd php8.2-curl php8.2-zip php8.2-gmp composer php8.2-fpm php8.2-mysql
...
sudo apt install php8.1-cli php8.1-fpm php8.1-common php8.1-mysql php8.1-zip php8.1-gd  php8.1-mbstring php8.1-curl php8.1-xml php8.1-bcmath -y

DB_PASS=$(openssl rand -base64 12)

mysql -u root -e "create database "$APP_USER"_db;" -p

mysql -u root -e  "CREATE USER "$APP_USER_"user@'%' IDENTIFIED BY "$DB_PASS";" -p 

mysql -u root -e  "GRANT ALL PRIVILEGES ON "$APP_USER"_db.* TO "$APP_USER_"user@'%';" -p
